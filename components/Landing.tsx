...
const Landing = () => {
  return (
    <div className="flex relative min-h-screen w-full flex-col flex-wrap items-center bg-blue-50 px-4 transition-colors duration-300 sm:px-20 dark:bg-neutral-950">
    <div
      className="fixed top-0 inset-0 z-0 hidden dark:inline"
      style={{
        backgroundImage: `
      ...
      <div
        className="fixed top-0 inset-0 z-0 dark:hidden"
        style={{
          backgroundImage: `
